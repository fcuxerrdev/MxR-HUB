  ...
  World3 = game.PlaceId == 100117331123089
	...
	toggleButton.Image = "rbxassetid://129711936638230"
	...
	if World3 then
		Tabs.Main:AddSection("تفريم")
		local TeleportToggle = Tabs.Main:AddToggle("tpSubmarineWorker", {
			Title = "قم بالطيران إلى مزرعة الشخصيات غير القابلة للعب (المستوى 2600 وما فوق)",
	...
	local FarmLevel = Tabs.Main:AddToggle("تفريم لفل", {
		Title = "اوتو تفريم لفل",
		Description = "مز يلفلك للماكس",
		Default = false
	})
	...
	local BossDropdown = Tabs.Main:AddDropdown("تفريم بوسات", {
		Title = "اختار البوس",
		Description = "اختار البوس لتفريم",
		Values = Boss,
		Default = 1,
		Callback = function(value)
			_G.FindBoss = value
	...
	local FarmBoss = Tabs.Main:AddToggle("FarmBoss", {
		Title = "اوتو تفريم بوس",
		Description = "تفريم البوس مختار",
		Default = false
	})
	...
	if World1 then
	local TravelDress = Tabs.Main:AddToggle("تنقل درس", {
		Title = "اوتو تنقل ل درسورا",
		Description = "لازم تكون عالم 2",
		Default = false
	})
	...
	if World2 then
	local Zou = Tabs.Main:AddToggle("زوو", {
		Title = "اوتو مهمو زوو",
		Description = "لازم تكون عالم 3",
		Default = false
	})
	...
	local ClosetMons = Tabs.Main:AddToggle("قريب", {
		Title = "اوتو تفريم قريب",
		Description = "...",
		Default = false
	})
	...
	local FactoryRaids = Tabs.Main:AddToggle("FactoryRaids", {
		Title = "اوتو تفريم مصنع",
		Description = "تفريم مصنع الي في عالم 2",
		Default = false
	})
	...
	local SafeModes = Tabs.Settings:AddToggle("SafeModes", {
		Title = "Panic Mode",
		Description = "تشغله لعدم موت لما دمك يصير قليل يحميك",
		Default = false
	})
	...
	local DisblesVFX = Tabs.Settings:AddToggle("DisblesVFX", {
		Title = "يفسخ logs",
		Description = "انصحك تشغلها ل تقليل لاق",
		Default = false
	})
	DisblesVFX:OnChanged(function(Value)
		RemoveDamage = Value
	...
	local StatusSelect = Tabs.Settings:AddSlider("StatusSelect", {
		Title = "Stats Value",
		Description = "حدد نوع المهارة التي تريد إضافة نقاط إليه",
		Default = 10,
		Min = 0,
		Max = 1000,
		Rounding = 1,
	...
	local Q = Tabs.Quests:AddToggle("Q", {
		...
		Description = "ذا يفرم بوس الي يرسبن كل 8 دقايق",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local Q = Tabs.Quests:AddToggle("Q", {
		...
		Description = "ياقف لما ياخذ كاس قود",
		Default = true
	})
	Q:OnChanged(function(Value)
	...
	local Q = Tabs.Quests:AddToggle("Q", {
		Title = "تنقل الي بياع سيف لنجدري",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local Q = Tabs.Quests:AddToggle("Q", {
		Title = "اوتو اسلوب دراجون ترايدن",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local Q = Tabs.Mirage:AddToggle("Q", {
		Title = "اوتو بحث على ميراج",
		Description = "تفعلها ل بحث على ميراج و تنقل اليها",
		Default = false
	})
	Q:OnChanged(function(Value)
		_G.FindMirage = Value
	...
	local Q = Tabs.Mirage:AddToggle("Q", {
		Title = "ذاهب الي اعلى نقطة في ميراج",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local Q = Tabs.Mirage:AddToggle("Q", {
		Title = "اوتو تفريم متريال ل سول قيتار",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local Q = Tabs.Mirage:AddToggle("Q", {
		Title = "اوتو اكتمال مهمة ال رايس",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local UpTalon = Tabs.Drago:AddToggle("UpTalon", {
		Title = "تطوير اسلوب نار مع uzoth ",
		Description = "",
		Default = false
	})
	...
	Vocan = Tabs.Prehistoric:AddToggle("Vocan", {
		Title = "بحث على بركان",
		Description = "تشغله للبحث على جزيرة و انتقال اليه",
		Default = false
	})
	...
	Toggle = Tabs.Prehistoric:AddToggle("Toggle", {
		Title = "اوتو رست لما يخلص ال جزيرة بركان",
	...
	Q = Tabs.SeaEvent:AddToggle("Q", {
		Title = "اوتو Haunted Crew Member",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	Q = Tabs.SeaEvent:AddToggle("Q", {
		Title = "اوتو Attack PirateGrandBrigade",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local Q = Tabs.SeaEvent:AddToggle("Q", {
		Title = "بحث على جزيرة كيتسون",
		Description = "بحث على جزيرة و انتقال إليها",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local Q = Tabs.SeaEvent:AddToggle("Q", {
		Title = "اوتو انتقال Shrine Actived",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	Tabs.SeaEvent:AddButton({
		...
		Tabs.SeaEvent:AddSection("لازم تكون عالم 3")
		end
	...
	Tabs.Raids:AddButton({
		Title = "شراء رايد مختار (بالفواكه)",
...
spawn(function()
	...
	local Q = Tabs.Raids:AddToggle("Q", {
		Title = "اوتو انتقال الى جزيرة الي بعدها",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	Q = Tabs.Combat:AddToggle("Q", {
		Title = "تصير سريع كثير",
		Description = "تشغله بيخليك تفعل رايس الارنب بدون ملكه",
		Default = false
	})
	Q:OnChanged(function(Value)
		InfAblities = Value
	...
	Q = Tabs.Combat:AddToggle("Q", {
		Title = "تصير عندي energyلا نهائية",
		Description = "انا سويت سكربتتت ادعمنييي",
		Default = false
	})
	Q:OnChanged(function(Value)
		infEnergy = Value
	...
	Q = Tabs.Combat:AddToggle("Q", {
		Title = "تخلي هاكي روئية عندك قوي بمراحلل",
	...
	if World3 then
		...
		Q = Tabs.Combat:AddToggle("Q", {
			Title = "روئية جزر في بحر",
			Description = "مثل جزيرة بركان...",
			Default = false
		})
		Q:OnChanged(function(Value)
